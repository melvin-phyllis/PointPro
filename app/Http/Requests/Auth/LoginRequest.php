...
class LoginRequest extends FormRequest
{
     ...
     * Accepte l'email OU le matricule comme identifiant.
     *
    ...
    public function authenticate(): void
    {
        ...
        // Si ce n'est pas un email valide → chercher par matricule
        $email = filter_var($login, FILTER_VALIDATE_EMAIL)
            ? $login
            : optional(User::where('employee_id_number', $login)->first())->email;
