...
const icons = {
    ...
    invoices: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />,
    plans: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />,
...
export default function AuthenticatedLayout({ children }: PropsWithChildren) {
    ...
    const navItems: NavItem[] = isSuperAdmin
        ? [
            { label: 'Dashboard', href: route('admin.dashboard'), routeName: 'admin.dashboard', icon: icons.dashboard, roles: ['super_admin'] },
            { label: 'Entreprises', href: route('admin.companies.index'), routeName: 'admin.companies.*', icon: icons.depts, roles: ['super_admin'] },
            { label: 'Paiements', href: route('admin.payments.index'), routeName: 'admin.payments.*', icon: icons.payments, roles: ['super_admin'] },
            { label: 'Factures', href: route('admin.invoices.index'), routeName: 'admin.invoices.*', icon: icons.invoices, roles: ['super_admin'] },
            { label: 'Plans', href: route('admin.plans.index'), routeName: 'admin.plans.*', icon: icons.plans, roles: ['super_admin'] },
            { label: 'Support', href: route('admin.tickets.index'), routeName: 'admin.tickets.*', icon: icons.tickets, roles: ['super_admin'] },
            { label: 'Paramètres', href: route('admin.settings.index'), routeName: 'admin.settings.*', icon: icons.settings, roles: ['super_admin'] },
        ]
        : [
            {
