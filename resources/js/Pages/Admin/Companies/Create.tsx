        ...
        <AuthenticatedLayout>
            ...
            <div className="mx-auto max-w-lg space-y-6">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                    ...
                    <span>/</span><span className="text-gray-200">Nouvelle</span>
                </div>

                <h1 className="text-xl font-bold text-white">Ajouter une entreprise</h1>

                <form onSubmit={submit} className="rounded-xl border border-white/10 bg-[#0D1117] p-6 space-y-4">
                    {([
                        ...
                        <div key={f.id}>
                            <label className="block text-xs font-medium text-gray-400 mb-1">{f.label}{f.required && ' *'}</label>
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        <Link href={route('admin.companies.index')} className="rounded-lg px-4 py-2 text-sm text-gray-400 hover:text-gray-200 transition">Annuler</Link>
