    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="mx-auto max-w-xl space-y-6">
                ...
                <h1 className="text-xl font-bold text-white">Créer un plan</h1>
                ...
                <form onSubmit={submit} className="space-y-4 rounded-xl border border-white/10 bg-[#0D1117] p-6">
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button type="submit" disabled={processing} className="rounded-lg bg-emerald-500 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-600 disabled:opacity-50">
