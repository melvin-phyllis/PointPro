        ...
        <AuthenticatedLayout>
            ...
            <div className="mx-auto max-w-xl space-y-6">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                    ...
                    <span>/</span><span className="text-primary">{plan.name}</span>
                </div>
                <h1 className="text-xl font-bold text-primary">Modifier le plan « {plan.name} »</h1>
                ...
                <form onSubmit={submit} className="space-y-4 rounded-xl border border-theme bg-surface p-6">
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input value={plan.slug} disabled
                                className="w-full rounded-lg border border-theme bg-subtle px-3 py-2 text-sm text-gray-500 cursor-not-allowed" />
                        </div>
                        <div>
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button type="submit" disabled={processing} className="rounded-lg bg-emerald-500 px-4 py-2 text-sm font-medium text-primary hover:bg-emerald-600 disabled:opacity-50 transition">
