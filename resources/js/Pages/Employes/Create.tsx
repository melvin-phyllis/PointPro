        ...
        <AuthenticatedLayout>
            ...
            <div className="mx-auto max-w-2xl space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold text-primary">Nouvel employé</h1>
                </div>
                ...
                <div className="flex items-start gap-3 rounded-xl border border-emerald-500/20 bg-emerald-500/5 px-4 py-3 text-sm">
                    ...
                    <div>
                        ...
                        <p className="mt-0.5 text-muted">
                            Format : <span className="font-mono text-primary">3 lettres du département + matricule</span>
                        </p>
                        <p className="mt-1 text-gray-500">
                            Aperçu : <span className="font-mono font-bold text-primary">{previewPass}</span>
                        </p>
