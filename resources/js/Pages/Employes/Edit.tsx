        ...
        <AuthenticatedLayout>
            ...
            <div className="mx-auto max-w-2xl space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold text-white">Modifier : {employee.full_name}</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="rounded-xl border border-white/10 bg-[#111827] p-6 space-y-5">
                    ...
                    <div className="flex items-center gap-3">
                        <label className="text-sm font-medium text-gray-400">Compte actif</label>
                        <input
                            type="checkbox"
                            checked={data.is_active}
                            onChange={e => setData('is_active', e.target.checked)}
                            className="h-4 w-4 rounded border-gray-600 bg-[#0D1117] text-emerald-500"
                        />
                    </div>
